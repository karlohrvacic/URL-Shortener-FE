...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <PageMeta title="Create an account" description="Sign up for a free hrva.cc account to manage your shortened URLs with analytics and control." />
      ...
      <div className="flex-1 flex items-center justify-center p-4 pt-24 relative">
        ...
        <Card className="w-full max-w-sm relative glass border-border/40 animate-scale-in">
          <CardHeader className="text-center pb-2 pt-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">Start managing your links</p>
          </CardHeader>
          <CardContent className="pb-8 px-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="confirmPassword" className="text-xs font-medium text-muted-foreground tracking-wide uppercase">
                  Confirm password
                </Label>
                <Input
                  id="confirmPassword"
